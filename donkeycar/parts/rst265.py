...
try:
    ...
    print(get_extrinsics(streams["left"], streams["right"]))
    ...
    #      \ fov /
    #        \|/
    stereo_fov_rad = 110 * (pi/180)  # 110 degree desired fov
    ...
    while counter < 100:
        ...
        if key == ord('q') or cv2.getWindowProperty(WINDOW_TITLE, cv2.WND_PROP_VISIBLE) < 1: print("should break")
finally:
    pipe.stop()
