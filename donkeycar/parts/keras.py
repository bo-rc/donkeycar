...
class KerasMotion(KerasPilot):
    ...
    '''
    def __init__(self, model=None, num_outputs=2, num_motion_inputs=12, input_shape=(120, 160, 3), *args, **kwargs):
    ...
    def run(self, img_arr, pos_x, pos_y, pos_z, vel_x, vel_y, vel_z, acl_x, acl_y, acl_z, gyr_x, gyr_y, gyr_z):
        #TODO: would be nice to take a vector input array.
        img_arr = img_arr.reshape((1,) + img_arr.shape)
        motion_arr = np.array([pos_x, pos_y, pos_z, vel_x, vel_y, vel_z, acl_x, acl_y, acl_z, gyr_x, gyr_y, gyr_z]).reshape(1,self.num_motion_inputs)
